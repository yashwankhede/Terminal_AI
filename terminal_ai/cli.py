...
from terminal_ai.core import (
    execute_command_live, execute_commands_sequence,
    ask_ai_for_commands, ask_ai_for_next_steps,
    extract_commands_from_response, find_controlled_terminal_for_command,
    open_new_terminal, send_command_to_terminal, read_terminal_output
)
from terminal_ai.utils import (
    ...
    check_command_exists, suggest_alternative,
    extract_subdomains_and_ips, add_to_hosts_file
)
...
def show_star_prompt():
    ...
    if is_first_run():
        ...
        print(f"{Colors.BOLD}{Colors.YELLOW}https://github.com/yashwankhede/Terminal_AI{Colors.RESET}")
        ...
        try:
            ...
            if commands:
                ...
                while next_commands and iteration < max_auto_iterations:
                    ...
                    command_history = execute_commands_sequence(next_commands, api_key, command_history)
